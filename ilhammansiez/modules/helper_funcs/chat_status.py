...
from ilhammansiez import dispatcher, DEL_CMDS, WHITELIST_USERS, TIGER_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS
...
from ilhammansiez.modules import connection
